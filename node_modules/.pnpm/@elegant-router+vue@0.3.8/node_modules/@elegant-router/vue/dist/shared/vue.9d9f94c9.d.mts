...
import { ElegantRouterOption } from '@elegant-router/core';

interface ElegantVueRouterOption extends ElegantRouterOption {
    /**
...
/** elegant const route */
type ElegantConstRoute = Omit<_RouteRecordBase, 'name' | 'path' | 'children'> & {
    name: string;
    path: string;
    component?: string;
...
export type { ElegantVueRouterOption as E, ElegantConstRoute as a };
